...
extension KRProgressHUD {
    ...
    func setConstraintsToPresentingVC() {
        ...
        view.addConstraints([
            NSLayoutConstraint(item: hudViewController.view as Any, attribute: .top, toItem: view),
            NSLayoutConstraint(item: hudViewController.view as Any, attribute: .bottom, toItem: view),
            NSLayoutConstraint(item: hudViewController.view as Any, attribute: .left, toItem: view),
            NSLayoutConstraint(item: hudViewController.view as Any, attribute: .right, toItem: view)
        ])
    }
}
