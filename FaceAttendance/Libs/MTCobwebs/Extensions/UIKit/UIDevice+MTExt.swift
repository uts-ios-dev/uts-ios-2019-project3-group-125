...
public extension UIDevice {
    ...
    /// 唯一标识符
    static func idForVendor() -> String {
    ...
    static func deviceModelReadable() -> String {
...
public extension UIDevice {
    ...
    static var diskFreeSize: UInt64 {
    ...
    static var diskUsedSize: UInt64 {
    ...
    static var allFileNumber: UInt64 {
